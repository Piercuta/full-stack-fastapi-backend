...
from app.core.auth_cookie import clear_auth_cookie, login_json_response
from app.core.config import settings
from app.core.security import get_password_hash
from app.models import CognitoLogin, Message, NewPassword, UserCreate, UserPublic
...
def login_access_token(
    ...
    Sets an HttpOnly cookie for browser clients; JSON body kept for API clients/tests.
    """
    ...
    return login_json_response(token)


@router.post("/login/cognito")
def login_cognito(session: SessionDep, body: CognitoLogin):
    """
